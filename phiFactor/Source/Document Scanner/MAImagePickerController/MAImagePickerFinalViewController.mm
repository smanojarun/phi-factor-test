...
- (void)viewDidLoad
{
   ...
   // [_finalImageView setFrame:CGRectMake(0, 0, self.view.bounds.size.width, self.view.bounds.size.height - (kCameraToolBarHeight + 70))];
    [_finalImageView setFrame:CGRectMake(0, 0, self.view.bounds.size.width, self.view.bounds.size.height - (kCameraToolBarHeight))];
...
//    FinalImagePreviewView *previewViewController = [[FinalImagePreviewView alloc] init];
//    previewViewController.imageFilePath = tmpPath;
