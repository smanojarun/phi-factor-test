...
class CustomSwitch: UIView {
    ...
    override func drawRect(rect: CGRect) {
        ...
        onLabel.textColor = UIColor.greenColor()
    ...
    func onOrOff(on : Bool){
        ...
        animateLabel(self.offLabel, toColor: (on ? whiteColor : UIColor.greenColor()))
        animateLabel(self.onLabel, toColor: (on ? UIColor.greenColor() : UIColor.whiteColor()))
